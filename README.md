...
1. DAG через задачи запрашивает данные из внешних API (погода, соцсети, CRM-системы).
2. Airflow преобразовывает данные: очистка, агрегация, джойны с другими источниками. Пример из проекта:
```  
